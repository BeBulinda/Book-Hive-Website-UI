        ...
        <div class="row">
            ...
            <div class="span9">
                <ul class="breadcrumb">
                    ...
                    <li><a href="?ecd_english">ECD English Books</a> <span class="divider">/</span></li>
                ...
                <div class="row">	  
                    ...
                    <div class="span6">
                        <h3>....Book Title....  </h3>
                        <small>Publisher - Maurice Mugeni</small>
                        <hr class="soft"/>
                        <form class="form-horizontal qtyFrm">
                            <div class="control-group">
                                <label class="control-label"><span> KShs. 222.00</span></label>
                                <div class="controls">
                        ...
                        <hr class="soft"/>
                        <h4>1000 books available in stock</h4>
                        <hr class="soft clr"/>
                        <p>
