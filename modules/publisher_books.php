<div id="mainBody">
    <div class="container">
        <div class="row">
            <div class="breadcrumb"> ECD Books </div>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="4" style="text-align:right"><strong>SUB-TOTAL (KShs) </strong></td>
                        <td class="label label-important" style="display:block"> <strong> 155.00 </strong></td>
                    </tr>
                </tbody>
            </table>

            <div class="breadcrumb"> Primary Books </div>
            ...
            <div class="breadcrumb"> Secondary Books </div>
            ...
            <div class="breadcrumb"> Lifestyle Books </div>
            ...
            <table class="table table-bordered">
                <tbody>
                    <tr>
                        <td colspan="4" style="text-align:right"><strong>GRAND TOTAL (KShs) </strong></td>
                        <td class="label label-important" style="display:block"> <strong> 155.00 </strong></td>
                    </tr>
                </tbody>
            </table>
